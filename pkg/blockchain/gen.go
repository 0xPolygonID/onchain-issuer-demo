...
//
// Solidity: function getRootsByState(uint256 historicalState) view returns((uint256,uint256,uint256))
func (_Identity *IdentityCaller) GetRootsByState(opts *bind.CallOpts, historicalState *big.Int) (OnChainIdentityRoots, error) {
	var out []interface{}
	err := _Identity.contract.Call(opts, &out, "getRootsByState", historicalState)
...
//
// Solidity: function getRootsByState(uint256 historicalState) view returns((uint256,uint256,uint256))
func (_Identity *IdentitySession) GetRootsByState(historicalState *big.Int) (OnChainIdentityRoots, error) {
	return _Identity.Contract.GetRootsByState(&_Identity.CallOpts, historicalState)
}

// GetRootsByState is a free data retrieval call binding the contract method 0xb8db6871.
//
// Solidity: function getRootsByState(uint256 historicalState) view returns((uint256,uint256,uint256))
func (_Identity *IdentityCallerSession) GetRootsByState(historicalState *big.Int) (OnChainIdentityRoots, error) {
	return _Identity.Contract.GetRootsByState(&_Identity.CallOpts, historicalState)
}
